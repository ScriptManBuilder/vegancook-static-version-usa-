...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'Course Introduction', name: 'Introduction' },
    { id: 'Appetizers', name: 'Appetizers' },
    { id: 'Main Dishes', name: 'Main Dishes' },
    { id: 'Advanced Mains', name: 'Advanced Mains' },
    { id: 'Side Dishes', name: 'Sides' },
    { id: 'Desserts', name: 'Desserts' },
    { id: 'Premium Desserts', name: 'Premium Desserts' },
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>Vegan Cooking Mastery Collection</PageTitle>
          <PageSubtitle>Master plant-based culinary arts with our comprehensive vegan holiday cooking video library</PageSubtitle>
        </PageHeader>
