  ...
  return (
    <AboutWrapper>
      <HeroSection ref={heroRef}>
        ...
        <LogoContainer>
          <MainLogo>VEGAN COOK HUB</MainLogo>
        </LogoContainer>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('VEGAN COOK HUB')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower home cooks worldwide with professional vegan culinary education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform plant-based cooking concepts into delicious, healthy meals.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted vegan cooking courses cover plant-based cooking principles, holiday meal preparation, appetizer techniques, main dish creation, dessert mastery, and nutritional optimization. Each course is designed with hands-on recipes, real-world applications, and professional techniques to help you master vegan cooking and transform your culinary skills for a healthier lifestyle.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our Vegan Cooking Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive plant-based culinary learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
          ...
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  <LeaderName>Culinary Expert</LeaderName>
                  <LeaderTitle>Vegan Cooking Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about vegan cooking and dedicated to making plant-based culinary education accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the art of professional vegan cooking.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in Vegan Culinary Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in vegan cooking education, constantly updating 
                  our curriculum with the latest plant-based techniques and culinary best practices.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  Vegan cooking should be accessible to everyone. We create a supportive environment 
                  where home cooks from all backgrounds can master plant-based cooking fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Plant-Based Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest vegan cooking tools and ingredients, 
                  bringing modern plant-based culinary practices directly to our students.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(31)}>
                <ValueIcon>🛡️</ValueIcon>
                <ValueTitle>Professional Culinary Standards</ValueTitle>
                <ValueDescription>
                  We prioritize creating delicious, nutritious vegan meals, teaching not just how to 
                  cook plant-based dishes, but how to prepare them efficiently and professionally.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  Vegan cooking is an evolving field. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical vegan cooking skills that you can apply immediately 
                  in your kitchen, from holiday meals to everyday dinners and elegant desserts.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of home cooks with world-class culinary education, 
                practical skills, and real-world recipes that drive healthy lifestyle success. 
                We believe that by making vegan cooking education accessible and excellent, we can help 
                students create delicious plant-based meals while creating opportunities for everyone 
                to participate in the sustainable food revolution.
              </MissionStatementText>
            </MissionStatement>
          </ValuesContainer>
        </Container>
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>Vegan Cooking Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional vegan culinary experts is dedicated to 
            transforming home cooking through comprehensive plant-based culinary education.
            <br /><br />
            We believe vegan cooking should be accessible to everyone, from complete beginners to experienced cooks looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex vegan cooking concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of vegan cooking and empower them 
            with the knowledge and skills needed to create delicious plant-based meals and transform their lifestyle. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately in your kitchen.
            <br /><br />
            Whether you're just starting your vegan cooking journey or looking to master advanced culinary techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of professional vegan cooking together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
