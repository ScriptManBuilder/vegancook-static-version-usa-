...
const ShippingPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          {COMPANY_INFO.name} delivers Vegan Cooking courses digitally through our secure online learning platform. 
      ...
      <Section>
        ...
        <Paragraph>
          <strong>Our Vegan Cooking courses are 100% digital products.</strong> There are no physical items to ship. All course materials, 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased Vegan Cooking courses. No waiting, no shipping delays - 
      ...
      <Section>
        ...
        <Paragraph>
          Our digital Vegan Cooking courses are available worldwide with internet access. There are no geographical restrictions 
