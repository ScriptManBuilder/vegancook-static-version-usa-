    ...
    <Container>
      ...
      <Section>
        <Paragraph>
          ...
          This policy explains our approach to Vegan Cooking course returns and refunds for digital educational content.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          Our Vegan Cooking courses are digital products delivered instantly upon purchase. Due to the nature of digital 
      ...
      <Section>
        ...
        <Paragraph>
          Since our Vegan Cooking courses are delivered digitally through your online account, there are no physical items to return. 
      ...
      <Section>
        ...
        <Paragraph>
          Instead of returns, we offer a 7-day satisfaction guarantee on all Vegan Cooking course purchases. You may request a full refund 
      ...
      <Section>
        ...
        <Paragraph>
          To request a refund for your Vegan Cooking course:
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit to switch to a different Exel course<br/>
      ...
      <Section>
        ...
        <Paragraph>
          If you're not satisfied with your current course but would like to try a different Vegan Cooking course from our collection, 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          and improvements. This ensures ongoing value for your investment in Vegan Cooking education.
        </Paragraph>
      </Section>
