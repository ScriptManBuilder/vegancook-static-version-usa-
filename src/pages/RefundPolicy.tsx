...
const RefundPolicy: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Section>
        <Paragraph>
          At {COMPANY_INFO.name}, we stand behind the quality of our Vegan Cooking courses and want you to be satisfied with your learning experience. 
                    This policy outlines the refund process and eligibility for Vegan Cooking course purchases.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <Paragraph>
          We offer a 7-day satisfaction guarantee on all Vegan Cooking course purchases. You may request a refund within 7 days 
      ...
      <Section>
        ...
        <Paragraph>
          ...
          You will see "VEGAN COOK HUB" or "VEGANCOOKHUB.COM" as the refund descriptor on your statement.
        </Paragraph>
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          • Request a course credit for a different Vegan Cooking course that better suits your needs<br/>
